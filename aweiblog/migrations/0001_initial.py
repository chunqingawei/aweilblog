# Generated by Django 3.2.4 on 2021-06-17 21:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ManyToManyField(to='aweiblog.Category', verbose_name='博客分类')),
                ('tag', models.ManyToManyField(to='aweiblog.Tag', verbose_name='博客标签')),
            ],
            options={
                'verbose_name': '博客',
